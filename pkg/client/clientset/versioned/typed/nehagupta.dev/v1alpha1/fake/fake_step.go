...
type FakeSteps struct {
	Fake *FakeNehaguptaV1alpha1
	ns   string
}

var stepsResource = schema.GroupVersionResource{Group: "nehagupta.dev", Version: "v1alpha1", Resource: "steps"}

var stepsKind = schema.GroupVersionKind{Group: "nehagupta.dev", Version: "v1alpha1", Kind: "Step"}
...
func (c *FakeSteps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(stepsResource, c.ns, name, opts), &v1alpha1.Step{})
